...
extension Seeds {
    struct HitSamples {
        ...
        static let hitVMOne: Hits.HitViewModel = Hits.HitViewModel(title: "Test 1", subTitle: "Subtitle 1", url: "URL 1")
        static let hitVMTwo: Hits.HitViewModel = Hits.HitViewModel(title: "Test 2", subTitle: "Subtitle 2", url: "URL 2")
